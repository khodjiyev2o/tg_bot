...
@dp.callback_query_handler(text="salohiddin")
...
@dp.callback_query_handler(text="jurabek")
async def enter_name(call: CallbackQuery):
...
@dp.callback_query_handler(text="jurabek_okcheon")
async def enter_name(call: CallbackQuery):
...
@dp.callback_query_handler(text="jurabek_chongju")
async def enter_name(call: CallbackQuery):
